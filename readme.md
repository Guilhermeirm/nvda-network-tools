...
This README intentionally keeps things brief — the add-on ships with a complete, in-depth guide covering every screen, field, and setting, available both in [English](https://htmlpreview.github.io/?https://github.com/Guilhermeirm/nvda-network-tools/blob/main/doc/en/readme.html) and [Portuguese](https://htmlpreview.github.io/?https://github.com/Guilhermeirm/nvda-network-tools/blob/main/doc/pt_BR/readme.html), and directly from within NVDA (Add-ons Store → Network Tools → About).
